            ...
            <div class="card-body has-select2">
                ...
                <div class="row">
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input class="form-control" type="text" name="account_no_prefix" value="{{ $general->account_no_prefix }}">
                    </div>
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input class="form-control" type="number" name="account_no_length" value="{{ $general->account_no_length }}">
                    </div>
                    ...
                    <div class="form-group col-md-4 col-sm-12">
                        ...
                        <div class="input-group">
                            <input class="form-control" type="number" name="otp_time" value="{{ getAmount($general->otp_time) }}">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-sm-6 col-md-4">
                        ...
                        <div class="input-group">
                            <input type="number" step="any" class="form-control" name="minimum_transfer_limit" value="{{ getAmount($general->minimum_transfer_limit) }}">
                    ...
                    <div class="form-group col-sm-6 col-md-4">
                        ...
                        <div class="input-group">
                            <input type="number" step="any" class="form-control" name="daily_transfer_limit" value="{{ getAmount($general->daily_transfer_limit) }}">
                            <span class="input-group-text curency-text">@lang($general->cur_text)</span>
                        </div>
                    </div>
                    <div class="form-group col-sm-12 col-md-4">
                        ...
                        <div class="input-group">
                            <input type="number" step="any" class="form-control" name="monthly_transfer_limit" value="{{ getAmount($general->monthly_transfer_limit) }}">
                            <span class="input-group-text curency-text">@lang($general->cur_text)</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <div class="input-group">
                            <input type="number" step="any" class="form-control" name="fixed_transfer_charge" value="{{ getAmount($general->fixed_transfer_charge) }}">
                            <span class="input-group-text curency-text">@lang($general->cur_text) </span>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <div class="input-group">
                            <input type="number" step="any" class="form-control" name="percent_transfer_charge" value="{{ getAmount($general->percent_transfer_charge) }}">
