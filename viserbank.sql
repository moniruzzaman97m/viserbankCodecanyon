...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2023 at 11:00 AM
...
(1, 'Super Admin', 'admin@gmail.com', 'admin', NULL, '635cd87f0fdb61667029119.png', '$2y$10$JZ.xgaJ6lSjyYFqSE5Dipe8JhhR5QWFpGGuumcHpf9CQFhV7M1Bky', 'iGGWs5rXL3E0yo5J5ylHJ2JJa2eUqMiVOCPuKl2Ot8hpg4uZpXasWqPOxT2t', NULL, '2022-10-29 07:38:39');
...
CREATE TABLE `balance_transfers` (
  ...
  `wire_transfer_data` text DEFAULT NULL,
...
CREATE TABLE `beneficiaries` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL,
  `beneficiary_type` varchar(40) DEFAULT NULL,
...
CREATE TABLE `branches` (
  ...
  `routing_number` varchar(40) DEFAULT NULL,
...
CREATE TABLE `dps` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `dps_number` varchar(40) DEFAULT NULL,
  `user_id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `general_settings` (
  ...
  `account_no_prefix` varchar(40) DEFAULT NULL,
  ...
  `percent_transfer_charge` decimal(5,0) NOT NULL DEFAULT 0,
...
(18, 'WITHDRAW_OTP', 'OTP for Withdraw', 'OTP for Withdraw', '<div>Your {{site_name}} OTP is {{otp}}</div>', 'Your {{site_name}} OTP is {{otp}}', '{\r\n    \"sitename\": \"Site Name\",\r\n    \"otp\": \"One Time Password\"\r\n}', 1, 1, '2021-07-10 21:21:19', '2022-08-14 04:00:35'),
(19, 'FDR_OTP', 'OTP for FDR Apply', 'OTP for FDR Apply', '<div>Your {{site_name}} OTP is {{otp}}</div>', 'Your{{site_name}} OTP is {{otp}}', '{\r\n    \"site_name\": \"Site Name\",\r\n    \"otp\": \"One Time Password\"\r\n}', 1, 1, '2021-07-10 21:21:19', '2022-08-03 23:27:02'),
(20, 'DPS_OTP', 'OTP for DPS Apply', 'OTP for DPS Apply', '<div>Your {{site_name}} OTP is {{otp}}</div>', 'Your {{site_name}} OTP is {{otp}}', '{\r\n    \"site_name\": \"Site Name\",\r\n    \"otp\": \"One Time Password\"\r\n}', 1, 1, '2021-07-10 21:21:19', '2021-07-10 21:21:19'),
(21, 'OWN_BANK_TRANSFER_OTP', 'OTP for Own Bank Transfer', 'OTP for Own Bank Transfer', '<div>Your {{site_name}} OTP is {{otp}}</div>', 'Your{{site_name}} OTP is {{otp}}', '{\r\n    \"site_name\": \"Site Name\",\r\n    \"otp\": \"One Time Password\"\r\n}', 1, 1, '2021-07-10 21:21:19', '2022-08-08 06:04:22'),
(22, 'OTHER_BANK_TRANSFER_OTP', 'OTP for Other Bank Transfer Request', 'OTP for Other Bank Transfer Request', '<div>Your {{site_name}} OTP is {{otp}}</div>', 'Your {{site_name}} OTP is {{otp}}', '{\r\n    \"site_name\": \"Site Name\",\r\n    \"otp\": \"One Time Password\"\r\n}', 1, 1, '2021-07-10 21:21:19', '2021-07-10 21:21:19'),
(23, 'WIRE_TRANSFER_OTP', 'OTP for Wire Transfer Request', 'OTP for Wire Transfer Request', '<div>Your {{site_name}} OTP is {{otp}}</div>', 'Your {{site_name}} OTP is {{otp}}', '{\r\n    \"site_name\": \"Site Name\",\r\n    \"otp\": \"One Time Password\"\r\n}', 1, 1, '2021-07-10 21:21:19', '2021-07-10 21:21:19'),
(24, 'FDR_OPENED', 'FDR Opened successfully', 'FDR Opened successfully', '<div>Your request for opening an FDR is approved successfully.</div>\r\n<div>FDR No. :&nbsp; &nbsp;{{fdr_number}}<br>Plan : {{plan_name}} </div>\r\n<div>Amount :&nbsp;{{amount}}</div>\r\n<div>Locked till :&nbsp;{{locked_date}}&nbsp;</div>\r\n<div>Interest Rate :&nbsp;{{interest_rate}}</div>\r\n<div>Get Interest Every :&nbsp;{{installment_interval}} days</div>\r\n<div><br></div>\r\n<div>You will get your first profit on&nbsp;{{next_installment_date}}</div>\r\n<div><br></div>', 'Your FDR request of {{amount}} is approved successfully. FDR No.: {{fdr_number}}\r\nYou cant withdraw the amount till {{locked_date}}', '{\n     \"plan_name\": \"Plan name\",\n     \"fdr_number\": \"FDR Number\",\n     \"amount\": \"Deposited Amount\",\n     \"locked_date\": \"User can not withdraw the amount till that date\",\n     \"per_installment\": \"The amount user will get in per installment\",\n     \"interest_rate\": \"Interest rate\",\n     \"installment_interval\": \"How many days the user will receive an installment\",\n     \"next_installment_date\": \"The date of next installment\"\n}', 1, 1, '2021-07-10 21:21:19', '2022-11-24 12:48:06'),
(25, 'FDR_CLOSED', 'FDR Closed', 'FDR Closed', 'Your &nbsp; <span style=\"color: rgb(33, 37, 41);\">&nbsp;{{plan_name}}&nbsp;</span>FDR Plan close request was approved successfully. The main amount {{amount}} {{site_currency}} has been credited to your account.', 'Your  {{plan_name}} FDR Plan closed successfully. The main amount {{amount}} {{site_currency}} has been credited to your account.', '{\n     \"fdr_number\": \"FDR number\",\n     \"amount\": \"Deposited Amount\",\n     \"profit\": \"Sum of installment received by user\",\n     \"per_installment\": \"Profit amount per interval\",\n     \"currency\": \"Site currency\",\n     \"plan_name\": \"Plan name\",\n     \"post_balance\": \"User\'s balance after this operation\"\n\n}', 1, 1, '2021-07-10 21:21:19', '2022-11-24 12:47:32'),
(26, 'DPS_OPENED', 'DPS Opened', 'DPS Opened successfully', '<div> Your application to open a DPS approved successfully<br>{{plan_name}} </div>', 'Your {{plan_name}}', '{\n     \"plan_name\": \"Plan Name\",\n     \"dps_number\": \"DPS Number\",\n     \"per_installment\": \"Installment amount\",\n     \"interest_rate\": \"Users profit rate on the total deposited amount\",\n     \"installment_interval\": \"How many days in an installment\",\n     \"delay_value\": \"How many days of delay the charge will be applied\",\n     \"charge_per_installment\": \"Installment delay charge for each day\",\n     \"delay_charge\": \"Total installment delay charge\",\n     \"given_installment\": \"How many installments given by the user\",\n     \"total_installment\": \"How many installments for this plan\",\n     \"next_installment_date\": \"Next installment date\",\n     \"total_deposited\": \"The summation of installments\",\n     \"withdrawable_amount\": \"The amount user can withdraw after mature\"\n}', 1, 1, '2021-07-10 21:21:19', '2021-07-27 22:49:00'),
(27, 'DPS_MATURED', 'DPS Matured', 'Dps matured', '<div> Your DPS is matured now<br>{{plan_name}} </div>', 'Your {{plan_name}}', '{\n     \"plan_name\": \"Plan Name\",\n     \"dps_number\": \"DPS Number\",\n     \"per_installment\": \"Installment amount\",\n     \"interest_rate\": \"Users profit rate on the total deposited amount\",\n     \"installment_interval\": \"How many days in an installment\",\n     \"delay_value\": \"How many days of delay the charge will be applied\",\n     \"charge_per_installment\": \"Installment delay charge for each day\",\n     \"delay_charge\": \"Total installment delay charge\",\n     \"given_installment\": \"How many installments given by the user\",\n     \"total_installment\": \"How many installments for this plan\",\n     \"total_deposited\": \"The summation of installments\",\n     \"withdrawable_amount\": \"The amount user can withdraw after mature\"\n}', 1, 1, '2021-07-10 21:21:19', '2021-07-27 22:50:55'),
(28, 'DPS_CLOSED', 'DPS CLosed', 'DPS closed successfully', '<div> Your {{plan_name}} </div>', 'Your {{plan_name}}', '{\n     \"plan_name\": \"Plan Name\",\n     \"dps_number\": \"DPS Number\",\n     \"per_installment\": \"Installment amount\",\n     \"interest_rate\": \"Users profit rate on the total deposited amount\",\n     \"installment_interval\": \"How many days in an installment\",\n     \"delay_value\": \"How many days of delay the charge will be applied\",\n     \"charge_per_installment\": \"Installment delay charge for each day\",\n     \"delay_charge\": \"Total installment delay charge\",\n     \"given_installment\": \"How many installments are given by the user\",\n     \"total_installment\": \"How many installments for this plan\",\n     \"next_installment_date\": \"Next installment date\",\n     \"total_deposited\": \"The summation of installments\",\n     \"withdrawn_amount\": \"The amount user has withdrawn\"\n}', 1, 1, '2021-07-10 21:21:19', '2021-07-10 21:21:19'),
(29, 'DPS_INSTALLMENT_DUE', 'DPS instalment Due', 'DPS instalment Due', 'Please recharge your balance for the DPS instalment&nbsp;<br><br><br>', 'Please recharge your balance for the DPS instalment', '{\n     \"dps_number\": \"DPS Number\",\n     \"per_installment\": \"Installment amount\",\n     \"interest_rate\": \"Users profit rate on the total deposited amount\",\n     \"installment_interval\": \"How many days in an installment\",\n     \"delay_value\": \"How many days of delay the charge will be applied\",\n     \"charge_per_installment\": \"Installment delay charge for each day\",\n     \"delay_charge\": \"Total installment delay charge\",\n     \"given_installment\": \"How many installments are given by the user\",\n     \"total_installment\": \"How many installments for this plan\",\n     \"installment_date\": \"Installment date\"\n}', 1, 1, '2021-07-10 21:21:19', '2022-08-27 07:26:47'),
(30, 'LOAN_APPROVE', 'Loan Approved Successfully', 'Loan Approved Successfully', '<div>Your request for a loan is approved successfully<br><br>&nbsp;Your {{plan_name}} </div>', 'Your {{plan_name}}', '{\n     \"plan_name\": \"Plan name\",\n     \"loan_number\": \"Loan number\",\n     \"amount\": \"Loan amount\",\n     \"per_installment\": \"Installment amount\",\n     \"payable_amount\": \"Payable amount for user\",\n     \"installment_interval\": \"How many days in an installment\",\n     \"delay_value\": \"How many days of delay the charge will be applied\",\n     \"charge_per_installment\": \"Installment delay charge for each day\",\n     \"delay_charge\": \"Total installment delay charge\",\n     \"given_installment\": \"How many installments are given by the user\",\n     \"total_installment\": \"How many installments for this plan\",\n     \"next_installment_date\": \"Next installment date\"\n}', 1, 1, NULL, NULL),
(31, 'LOAN_REJECT', 'Loan Request Rejected', 'Loan Request Rejected', '<div> Your application for a loan is rejected by the authority <br>{{plan_name}} </div>', 'Your {{plan_name}}', '{\n     \"plan_name\": \"Plan name\",\n     \"loan_number\": \"Loan number\",\n     \"amount\": \"Loan amount\",\n     \"per_installment\": \"Installment amount\",\n     \"payable_amount\": \"Payable amount for user\",\n     \"installment_interval\": \"How many days in an installment\",\n     \"delay_value\": \"How many days of delay the charge will be applied\",\n     \"charge_per_installment\": \"Installment delay charge for each day\",\n     \"delay_charge\": \"Total installment delay charge\",\n     \"given_installment\": \"How many installments are given by the user\",\n     \"total_installment\": \"How many installments for this plan\",\n     \"reason_of_rejection\": \"Reason of rejection\"\n}', 1, 1, NULL, NULL),
(36, 'LOAN_INSTALLMENT_DUE', 'Loan Installment Due', 'Loan installment due', '<div>Please recharge your balance for installment&nbsp;<br><br>{{plan_name}} </div>', 'Your {{plan_name}}', '{\n     \"loan_number\": \"Loan number\",\n     \"amount\": \"Loan amount\",\n     \"per_installment\": \"Installment amount\",\n     \"payable_amount\": \"Payable amount for user\",\n     \"installment_interval\": \"How many days in an installment\",\n     \"delay_value\": \"How many days of delay the charge will be applied\",\n     \"charge_per_installment\": \"Installment delay charge for each day\",\n     \"delay_charge\": \"Total installment delay charge\",\n     \"given_installment\": \"How many installments are given by the user\",\n     \"total_installment\": \"How many installments for this plan\",\n     \"installment_date\": \"Installment date\"\n}', 1, 1, '2021-07-10 21:21:19', '2022-08-22 22:12:54'),
(37, 'LOAN_PAID', 'Loan Paid', 'Loan completed', '<div> You paid all installment<br>{{plan_name}} </div>', 'Your {{plan_name}}', '{\n     \"plan_name\": \"Plan name\",\n     \"loan_number\": \"Loan number\",\n     \"amount\": \"Loan amount\",\n     \"per_installment\": \"Installment amount\",\n     \"payable_amount\": \"Payable amount for user\",\n     \"installment_interval\": \"How many days in an installment\",\n     \"delay_value\": \"How many days of delay the charge will be applied\",\n     \"charge_per_installment\": \"Installment delay charge for each day\",\n     \"delay_charge\": \"Total installment delay charge\",\n     \"given_installment\": \"How many installments are given by the user\",\n     \"total_installment\": \"How many installments for this plan\"\n}', 1, 1, '2021-07-10 21:21:19', '2021-07-27 22:46:44'),
(38, 'OTHER_BANK_TRANSFER_REQUEST_SEND', 'Other Bank Money Transfer Request Sent', 'Money Transfer Request Sent Successfully', '<font color=\"#212529\"><span style=\"font-size: 12px; white-space: nowrap;\"><b>{{sending_amount}}&nbsp;{{site_currency}}</b></span></font>&nbsp;transfer request submitted&nbsp;successfully', '{{sending_amount}} {{site_currency}} sent to {recipient_account_number} successfully', '{\n     \"sender_account_number\": \"Sender account number\",\n     \"sender_account_name\": \"Sender account name\",\n     \"recipient_account_number\": \"Recipient account number\",\n     \"recipient_account_name\": \"Recipient account name\",\n     \"sending_amount\": \"The amount to be transferred\",\n     \"charge\": \"Transfer charge\",\n     \"final_amount\": \"The amount including charge\",\n     \"bank_name\": \"Name of the bank of recipient\"\n}', 1, 1, '2021-07-10 15:21:19', '2022-11-14 10:56:30'),
(39, 'OTHER_BANK_TRANSFER_COMPLETE', 'Other Bank Money Transfer Completed', 'Money Transfer Completed Successfully', '<span style=\"color: rgb(33, 37, 41); font-size: 12px; font-weight: 600; white-space: nowrap;\">{{sending_amount}}&nbsp;</span><span style=\"color: rgb(33, 37, 41); font-size: 12px; font-weight: 600; white-space: nowrap;\">{{currency}}</span>&nbsp;sent to&nbsp;<span style=\"color: rgb(33, 37, 41); font-size: 12px; font-weight: 600; white-space: nowrap;\">{{recipient_account_number}}</span>&nbsp;successfully', '{{amount}} {{currency}} sent to {{recipient_account_number}} successfully', '{\n     \"sender_account_number\": \"Sender account number\",\n     \"sender_account_name\": \"Sender account name\",\n     \"recipient_account_number\": \"Recipient account number\",\n     \"recipient_account_name\": \"Recipient account name\",\n     \"sending_amount\": \"The amount to be transferred\",\n     \"charge\": \"Transfer charge\",\n     \"final_amount\": \"The amount including charge\",\n     \"bank_name\": \"Name of the bank of recipient\"\n}', 1, 1, '2021-07-10 15:21:19', '2022-11-24 12:49:45'),
(40, 'OTHER_BANK_TRANSFER_REJECT', 'Other Bank Money Transfer Rejected', 'Money Transfer Rejected', '<font color=\"#212529\"><span style=\"font-size: 12px; white-space: nowrap;\"><b>{{sending_amount}}&nbsp;{{site_currency}}</b></span></font>&nbsp;transfer request is rejected for&nbsp;{{reject_reason}} &nbsp;and the amount has refunded to your account', '{{amount}}{{currency}} sent to {{recipient_account_number}} successfully', '{\n     \"sender_account_number\": \"Sender account number\",\n     \"sender_account_name\": \"Sender account name\",\n     \"recipient_account_number\": \"Recipient account number\",\n     \"recipient_account_name\": \"Recipient account name\",\n     \"sending_amount\": \"The amount to be transferred\",\n     \"charge\": \"Transfer charge\",\n     \"final_amount\": \"The amount including charge\",\n     \"bank_name\": \"Name of the bank of recipient\",\n     \"reject_reason\": \"Reject reason of transaction\"\n}', 1, 1, '2021-07-10 15:21:19', '2022-11-24 12:50:25'),
(41, 'WIRE_TRANSFER_REQUEST_SEND', 'Wire Transfer Request Sent', 'Money Transfer Request Sent Successfully', '<span style=\"color: rgb(33, 37, 41); font-size: 12px; font-weight: 600; white-space: nowrap;\">{{sending_amount}}&nbsp;</span><span style=\"color: rgb(33, 37, 41); font-size: 12px; font-weight: 600; white-space: nowrap;\">{{site_currency}} Wire</span>&nbsp;transfer request submitted&nbsp;successfully', '{{sending_amount}} {{site_currency}} Wire transfer request submitted successfully', '{\n     \"sender_account_number\": \"Sender account number\",\n     \"sender_account_name\": \"Sender account name\",\n     \"recipient_account_number\": \"Recipient account number\",\n     \"recipient_account_name\": \"Recipient account name\",\n     \"sending_amount\": \"The amount to be transferred\",\n     \"charge\": \"Transfer charge\",\n     \"final_amount\": \"The amount including charge\"\n}', 1, 1, '2021-07-10 15:21:19', '2022-11-24 12:53:45'),
(42, 'WIRE_TRANSFER_COMPLETED', 'Wire Transfer Completed', 'WireTransfer Completed Successfully', '<span style=\"color: rgb(33, 37, 41); font-size: 12px; font-weight: 600; white-space: nowrap;\">{{sending_amount}}&nbsp;</span><span style=\"color: rgb(33, 37, 41); font-size: 12px; font-weight: 600; white-space: nowrap;\">{{site_currency}}</span>&nbsp;sent to&nbsp;successfully', '{{sending_amount}} {{site_currency}} sent to successfully', '{\n     \"sender_account_number\": \"Sender account number\",\n     \"sender_account_name\": \"Sender account name\",\n     \"recipient_account_number\": \"Recipient account number\",\n     \"recipient_account_name\": \"Recipient account name\",\n     \"sending_amount\": \"The amount to be transferred\",\n     \"charge\": \"Transfer charge\",\n     \"final_amount\": \"The amount including charge\"\n}', 1, 1, '2021-07-10 15:21:19', '2022-11-24 12:53:01'),
(43, 'WIRE_TRANSFER_REJECTED', 'Wire Transfer Rejected', 'Wire Transfer Rejected Successfully', '<span style=\"color: rgb(33, 37, 41); font-size: 12px; font-weight: 600; white-space: nowrap;\">{{sending_amount}}&nbsp;</span><span style=\"white-space: nowrap; font-weight: 600; font-size: 12px; color: rgb(33, 37, 41);\">{{site_currency}}</span>&nbsp;transfer request is rejected for&nbsp;{{reject_reason}} &nbsp;and the amount has refunded to your account', '{{sending_amount}} {{site_currency}} transfer request is rejected for {{reject_reason}}  and the amount has refunded to your account', '{\n     \"sender_account_number\": \"Sender account number\",\n     \"sender_account_name\": \"Sender account name\",\n     \"recipient_account_number\": \"Recipient account number\",\n     \"recipient_account_name\": \"Recipient account name\",\n     \"sending_amount\": \"The amount to be transferred\",\n     \"charge\": \"Transfer charge\",\n     \"final_amount\": \"The amount including charge\",\n     \"reject_reason\": \"Reject reason of transaction\"\n}', 1, 1, '2021-07-10 15:21:19', '2022-11-24 12:53:27'),
(44, 'DEPOSIT_VIA_BRANCH', 'Deposit From Branch', 'Deposited Successfullly', '<div style=\"\"><font face=\"Montserrat, sans-serif\">Dear&nbsp;</font><b style=\"font-family: Montserrat, sans-serif;\">{{username}},&nbsp;&nbsp;</b><span style=\"font-family: Montserrat, sans-serif; font-size: 1rem; text-align: var(--bs-body-text-align);\"><b>{{amount}}</b></span><span style=\"font-family: Montserrat, sans-serif; font-weight: 700; font-size: 1rem; text-align: var(--bs-body-text-align);\"> </span><span style=\"font-family: Montserrat, sans-serif; font-size: 1rem; text-align: var(--bs-body-text-align);\"><b>{{site_currency}}</b></span><span style=\"font-family: Montserrat, sans-serif; font-weight: 700; font-size: 1rem; text-align: var(--bs-body-text-align);\"> </span><span style=\"font-family: Montserrat, sans-serif; font-size: 1rem; text-align: var(--bs-body-text-align);\">added your account from the</span><span style=\"font-family: Montserrat, sans-serif; font-weight: 700; font-size: 1rem; text-align: var(--bs-body-text-align);\"> </span><span style=\"font-family: Montserrat, sans-serif; font-size: 1rem; text-align: var(--bs-body-text-align);\">branch</span><span style=\"font-family: Montserrat, sans-serif; font-weight: 700; font-size: 1rem; text-align: var(--bs-body-text-align);\">&nbsp;</span><span style=\"text-align: var(--bs-body-text-align);\"><font face=\"Montserrat, sans-serif\"><b>{{branch_name}}</b></font></span></div><div style=\"font-family: Montserrat, sans-serif;\"><br></div><div style=\"font-family: Montserrat, sans-serif;\"><span style=\"font-weight: bolder;\">Details of your Deposit :<br></span></div><div style=\"font-family: Montserrat, sans-serif;\"><br></div><div style=\"font-family: Montserrat, sans-serif;\">Amount : {{amount}} {{site_currency}}</div><div style=\"font-family: Montserrat, sans-serif;\">Charge:&nbsp;<font color=\"#FF0000\">{{charge}} {{site_currency}}</font></div><div style=\"font-family: Montserrat, sans-serif;\"><br></div><div style=\"font-family: Montserrat, sans-serif;\">Transaction Number : {{trx}}</div><div style=\"font-family: Montserrat, sans-serif;\"><font size=\"5\"><span style=\"font-weight: bolder;\"><br></span></font></div><div style=\"font-family: Montserrat, sans-serif;\"><font size=\"5\">Your current Balance is&nbsp;<span style=\"font-weight: bolder;\">{{post_balance}} {{site_currency}}</span></font></div><div style=\"font-family: Montserrat, sans-serif;\"><br></div><div style=\"font-family: Montserrat, sans-serif;\"><br></div>', 'Admin Approve Your {{amount}} {{site_currency}} payment request by {{method_name}} transaction : {{trx}}', '{\"trx\":\"Transaction number for the deposit\",\"amount\":\"Amount inserted by the Branch of user account\",\"charge\":\"Deposit Charge\",\"branch_name\":\"Name of the Branch\",\"post_balance\":\"Balance of the user after this transaction\",\"username\":\"username of the deposited user\"}', 1, 1, '2021-11-03 06:00:00', '2022-08-13 22:18:15'),
(45, 'WITHDRAW_VIA_BRANCH', 'Withdraw From Branch', 'Withdrawn Successfully', '<div style=\"\"><span style=\"font-family: Montserrat, sans-serif; font-weight: bolder;\">Your&nbsp;</span><span style=\"font-family: Montserrat, sans-serif; font-weight: 700; font-size: 1rem; text-align: var(--bs-body-text-align);\">withdraw successfulllyy from the Branch&nbsp;</span><span style=\"text-align: var(--bs-body-text-align);\"><font face=\"Montserrat, sans-serif\"><b>{{branch_name}}</b></font></span></div><div style=\"font-family: Montserrat, sans-serif;\"><span style=\"font-weight: bolder;\"><br></span></div><div style=\"font-family: Montserrat, sans-serif;\"><span style=\"font-weight: bolder;\">Details of your withdraw:<br></span></div><div style=\"font-family: Montserrat, sans-serif;\"><br></div><div style=\"font-family: Montserrat, sans-serif;\">Amount : {{amount}} {{site_currency}}</div><div style=\"font-family: Montserrat, sans-serif;\">Charge:&nbsp;<font color=\"#FF0000\">{{charge}} {{site_currency}}</font></div><div style=\"font-family: Montserrat, sans-serif;\"><br></div><div style=\"font-family: Montserrat, sans-serif;\"><br></div><div style=\"font-family: Montserrat, sans-serif;\">Transaction Number : {{trx}}</div><div style=\"font-family: Montserrat, sans-serif;\"><br></div><div style=\"font-family: Montserrat, sans-serif;\">-----</div><div style=\"font-family: Montserrat, sans-serif;\"><br></div><div style=\"font-family: Montserrat, sans-serif;\"><br></div>', 'Amount withdrawn successfully from the Branch {{branch_name}}', '        {\"trx\":\"Transaction number for the withdraw\",\"amount\":\"Amount Of Withdraw\",\"charge\":\"Amount Of Withdraw Charge\",\"branch_name\":\"Name of the withdraw branch\"}\r\n', 1, 1, '2021-11-03 06:00:00', '2022-08-14 05:39:00'),
(46, 'REFERRAL_COMMISSION', 'Referral Commission', 'Referral Commission', 'Congratulation, You you  {{amount}}&nbsp;{{site_currency}}&nbsp; interest And your main balance {{post_balance}}&nbsp;{{site_currency}}&nbsp; . {{level}} . Transaction {{trx}}', 'Congratulation, You you {{amount}} {{site_currency}}  interest And your main balance {{post_balance}} {{site_currency}}  . {{level}} . Transaction {{trx}}', '{\n     \"amount\": \"amount\",\n     \"post_balance\": \"Balance after commission received\",\n     \"trx\": \"Transaction Number\",\n     \"level\": \"level\"\n}', 1, 1, '2019-09-14 07:14:22', '2022-08-29 07:26:21'),
(47, 'OWN_BANK_TRANSFER_MONEY_SEND', 'Own Bank Transfer - Money Send', 'Money Transferred Successfully', 'Transfer Money Completed Successfully', 'Transfer Money Completed Successfully', '{\n     \"sender\": \"Who send the money\",\n     \"recipient\": \"Who receive the money\",\n     \"amount\": \"Transfer amount\",\n     \"charge\": \"Transfer charge\",\n     \"final_amount\": \"Final amount after charge\",\n     \"trx\": \"Transaction number\",\n     \"post_balance\": \"Balance after this operation\"\n}', 1, 1, NULL, NULL),
(48, 'OWN_BANK_TRANSFER_MONEY_RECEIVE', 'Own Bank Transfer - Money Receive', 'Transferred Money Received', 'You have received {{amount}}&nbsp;{{site_currency}}', 'You have received {{amount}} {{site_currency}}', '{\n     \"sender\": \"Who send the money\",\n     \"recipient\": \"Who receive the money\",\n     \"amount\": \"Transfer amount\",\n     \"charge\": \"Transfer charge\",\n     \"final_amount\": \"Final amount after charge\",\n     \"trx\": \"Transaction number\",\n     \"post_balance\": \"Balance after this operation\"\n}\n', 1, 1, NULL, '2022-11-14 11:21:15'),
(49, 'STAFF_CREDENTIALS', 'Staff Credentials', 'Staff Login Credentials', 'Email: {{email}}<br>Password: {{password}}<div><br></div><div><br>\r\n\r\n<a href=\"{{login_link}}\" style=\"\r\n    background: #4634ff;\r\n    color: #ffff;\r\n    padding: 10px 15px;\r\n    border-radius: 5px;\r\n\">Login Now</a>\r\n</div>', 'Email: {{email}}\r\nPassword: {{password}}', '{\n     \"email\": \"Staff Email\",\n     \"password\": \"Password\",\n     \"login_link\": \"Login Link for Staff\"\n\n}', 1, 1, NULL, '2022-11-27 10:20:16'),
(50, 'ACCOUNT_OPENED', 'Account Opened', 'Account Opened successfully', '<div> Your account has been opened successfully.<br>\r\n\r\n</div><div>Your Login Credentials</div><div>Username:{{username}}</div><div>Password:{{password}}</div><div><br></div>', 'Your account has been opened successfully.\r\nUsername:{{username}}\r\nPassword:{{password}}', '{\r\n    \"email\":\"Your Email Address\",\r\n    \"username\":\"Your username\",\r\n    \"Password\":\"Your Password\"\r\n}\r\n', 1, 1, '2021-07-10 21:21:19', '2022-12-05 10:24:55');
...
CREATE TABLE `otp_verifications` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `verifiable_type` varchar(255) NOT NULL,
  `verifiable_id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL,
  `otp` varchar(40) DEFAULT NULL,
  `send_via` varchar(255) DEFAULT NULL,
  `notify_template` varchar(40) DEFAULT NULL,
